 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  06:26:52 PM
 */
public class Question2 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("Question2", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Survey-Question3");
		return submit;
	}
	/**

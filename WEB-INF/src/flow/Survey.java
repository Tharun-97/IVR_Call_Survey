 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  02:59:54 PM
 */
public class Survey extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-07  06:10:01 PM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames = new java.util.ArrayList(4);
		
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("question1", ""));
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("question2", ""));
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("question3", ""));
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("question4", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(4);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("question1", "1.0"));
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("question2", "1.0"));
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("question3", "1.0"));
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("question4", "1.0"));

		events = new java.util.ArrayList();
		properties = new java.util.ArrayList();

		nbest = 1;
		field = new com.avaya.sce.runtime.Field("Survey", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("exit");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2022-DEC-07  06:10:01 PM
	 */
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-07  06:43:47 PM
	 */
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("Survey-exit", "exit");
		return exitPoints;
	}
}

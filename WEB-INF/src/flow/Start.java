...
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-26  02:52:35 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Language_Selection");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.BOOKING__ID_FIELD_CONFIDENCE,
			IProjectVariables.BOOKING__ID_FIELD_INPUTMODE,
			IProjectVariables.BOOKING__ID_FIELD_INTERPRETATION,
			IProjectVariables.BOOKING__ID_FIELD_NOINPUTCOUNT,
			IProjectVariables.BOOKING__ID_FIELD_NOMATCHCOUNT,
			IProjectVariables.BOOKING__ID_FIELD_UTTERANCE,
			IProjectVariables.BOOKING__ID_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.BOOKING__ID, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CDRSTORAGE_FIELD_MESSAGESIZE,
			IProjectVariables.CDRSTORAGE_FIELD_SUBJECTSIZE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CDRSTORAGE, variableFields, new String[] {"0", "0"}, "com.avaya.vp.admin.variables.runtime.AdminVariableFactory", session, false, true );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.STORED_IDS_FIELD_SUSEE,
			IProjectVariables.STORED_IDS_FIELD_THARUN };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.STORED_IDS, variableFields, new String[] {"9990", "2580"}, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NOTIFICATIONAPPNAME, "0", "com.avaya.vp.admin.variables.runtime.AdminVariableFactory", session, false, true );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CHOICE_FIELD_AVERAGE,
			IProjectVariables.CHOICE_FIELD_BAD,
			IProjectVariables.CHOICE_FIELD_GOOD };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CHOICE, variableFields, new String[] {"2", "3", "1"}, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.LANGUAGE__SELECTION_FIELD_CONFIDENCE,
			IProjectVariables.LANGUAGE__SELECTION_FIELD_INPUTMODE,
			IProjectVariables.LANGUAGE__SELECTION_FIELD_INTERPRETATION,
			IProjectVariables.LANGUAGE__SELECTION_FIELD_NOINPUTCOUNT,
			IProjectVariables.LANGUAGE__SELECTION_FIELD_NOMATCHCOUNT,
			IProjectVariables.LANGUAGE__SELECTION_FIELD_UTTERANCE,
			IProjectVariables.LANGUAGE__SELECTION_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.LANGUAGE__SELECTION, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CHECK_FIELD_CONFIDENCE,
			IProjectVariables.CHECK_FIELD_INPUTMODE,
			IProjectVariables.CHECK_FIELD_INTERPRETATION,
			IProjectVariables.CHECK_FIELD_NOINPUTCOUNT,
			IProjectVariables.CHECK_FIELD_NOMATCHCOUNT,
			IProjectVariables.CHECK_FIELD_UTTERANCE,
			IProjectVariables.CHECK_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CHECK, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.RATING_FIELD_VALUE_1,
			IProjectVariables.RATING_FIELD_VALUE_2,
			IProjectVariables.RATING_FIELD_VALUE_3,
			IProjectVariables.RATING_FIELD_VALUE_4,
			IProjectVariables.RATING_FIELD_VALUE_5 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.RATING, variableFields, new String[] {"", "", "", "", "4"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.QUESTION_3_FIELD_CONFIDENCE,
			IProjectVariables.QUESTION_3_FIELD_INPUTMODE,
			IProjectVariables.QUESTION_3_FIELD_INTERPRETATION,
			IProjectVariables.QUESTION_3_FIELD_NOINPUTCOUNT,
			IProjectVariables.QUESTION_3_FIELD_NOMATCHCOUNT,
			IProjectVariables.QUESTION_3_FIELD_UTTERANCE,
			IProjectVariables.QUESTION_3_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.QUESTION_3, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.QUESTION_2_FIELD_CONFIDENCE,
			IProjectVariables.QUESTION_2_FIELD_INPUTMODE,
			IProjectVariables.QUESTION_2_FIELD_INTERPRETATION,
			IProjectVariables.QUESTION_2_FIELD_NOINPUTCOUNT,
			IProjectVariables.QUESTION_2_FIELD_NOMATCHCOUNT,
			IProjectVariables.QUESTION_2_FIELD_UTTERANCE,
			IProjectVariables.QUESTION_2_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.QUESTION_2, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.QUESTION_4_FIELD_CONFIDENCE,
			IProjectVariables.QUESTION_4_FIELD_INPUTMODE,
			IProjectVariables.QUESTION_4_FIELD_INTERPRETATION,
			IProjectVariables.QUESTION_4_FIELD_NOINPUTCOUNT,
			IProjectVariables.QUESTION_4_FIELD_NOMATCHCOUNT,
			IProjectVariables.QUESTION_4_FIELD_UTTERANCE,
			IProjectVariables.QUESTION_4_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.QUESTION_4, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.QUESTION_1_FIELD_CONFIDENCE,
			IProjectVariables.QUESTION_1_FIELD_INPUTMODE,
			IProjectVariables.QUESTION_1_FIELD_INTERPRETATION,
			IProjectVariables.QUESTION_1_FIELD_NOINPUTCOUNT,
			IProjectVariables.QUESTION_1_FIELD_NOMATCHCOUNT,
			IProjectVariables.QUESTION_1_FIELD_UTTERANCE,
			IProjectVariables.QUESTION_1_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.QUESTION_1, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.ANSWERS_FIELD_ANSWER_1,
			IProjectVariables.ANSWERS_FIELD_ANSWER_2,
			IProjectVariables.ANSWERS_FIELD_ANSWER_3,
			IProjectVariables.ANSWERS_FIELD_ANSWER_4 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.ANSWERS, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MESSAGE_FIELD_USER };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MESSAGE, variableFields, new String[] {"9942044110"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.AUDIOS_FIELD_LANGUAGE,
			IProjectVariables.AUDIOS_FIELD_WELCOME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.AUDIOS, variableFields, new String[] {"C:/Users/Admin/Downloads/language.wav", "C:/Users/Admin/Downloads/welcome.wav"}, null, session, false, false );
		session.putVariable(variable);
